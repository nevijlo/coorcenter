...
const legalInfo = [
  { title: 'Терроризм', description: 'Ответственность по ст. 205, 206, 281-281.3 УК РФ' },
  { title: 'Экстремизм', description: 'Ответственность по ст. 282-282.3 УК РФ' },
          ...
          <div className="flex justify-between items-start gap-8">
            <div className="flex-1">
              ...
              <p className="text-lg sm:text-xl text-gray-200 mb-8 max-w-2xl">
                Безопасное пространство для своевременного сообщения о потенциальных угрозах и конфликтах в образовательной среде
              </p>
          ...
          <div className="max-w-2xl mx-auto">
            <form className="space-y-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8" onSubmit={handleSubmit}>
              ...
              <Alert className="bg-muted/50">
                ...
                <AlertDescription>
                  Он не заменяет обращение в правоохранительные органы, особенно в случаях, не терпящих
                  отлагательства, и не является способом сообщения о правонарушениях, преступлениях или угрозе
