...
const emergencyContacts = [
  ...
  { number: '02', label: 'МВД', description: 'Полиция' },
  { number: '02', label: 'ФСБ', description: 'Федеральная служба безопасности' },
  { number: '+7 (8182) 21-85-01', label: 'Служба безопасности САФУ', description: 'Внутренняя безопасность вуза' },
